# opencost-ai Governance

> **Note**
> `opencost-ai` is a sub-project of [OpenCost](https://github.com/opencost/opencost)
> under the CNCF umbrella. It inherits OpenCost's community governance
> model (this document mirrors the upstream
> [GOVERNANCE.md](https://github.com/opencost/opencost/blob/develop/GOVERNANCE.md)
> with project name substitution). CNCF Slack, community meetings,
> and the Working Group referenced below are the OpenCost community
> channels — this sub-project does not run its own.

This document attempts to clarify how the [opencost-ai](https://github.com/opencost/opencost-ai)
project is maintained. Anyone interested in improving the project may
join the community, contribute to the project, and participate in
shaping future releases. This document attempts to outline the general
participation structure and set expectations within the project
community.

## Code of Conduct

opencost-ai community members are expected to adhere to our published [Code of Conduct](CODE_OF_CONDUCT.md).

## Roles and Responsibilities

There are 4 levels of membership in the opencost-ai community.
...
For first-time contributors, it's recommended to start by going through [Contributing to opencost-ai](CONTRIBUTING.md) and joining our community Slack channel.
...
To become an opencost-ai member, you are expected to:
...
- Sponsored by at least 1 opencost-ai [maintainer or committer](MAINTAINERS.md)
...
Committers are granted `Triage` permissions for the opencost-ai repository.
...
Maintainers are first and foremost committers that have shown they are committed to the long term success of a project. They are the planners and designers of the opencost-ai project. Maintainership is about building trust with the current maintainers of the project and being a person that they can depend on to make decisions in the best interest of the project in a consistent manner.

Maintainers are granted `Write` permissions for the opencost-ai repository.

Committers wanting to become maintainers are expected to:

- Enable adoptions or ecosystems.
- Collaborate well.
- Demonstrate a deep and comprehensive understanding of opencost-ai's architecture, technical goals, and directions.
- Actively engage with major opencost-ai feature proposals and implementations.
...
The [OpenCost Community Meeting](https://bit.ly/opencost-meeting) is every 2 weeks at 1pm Pacific. Community Members are encouraged to attend and discuss development, events, and any other OpenCost community items of interest. opencost-ai shares this meeting with the parent project; it does not run a separate cadence.
...
> **Note**
> We intend to use a Request for Comments (RFC) process for any substantial changes to opencost-ai, but this has yet to be developed.
